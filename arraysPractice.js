...
//Your Code Here
var user2 = {name: 'Rafael Rodriguez', email: 'rafase282@gmail.com',password: 'youwish', username: 'Rafase282'};
var user3 = {name: 'Jose javier', email: 'rafase@gmail.com',password: 'youwishagain', username: 'pabloescobar'};
...
Once you find the particular index he's located in, delete him from the array.*/
  ...
  //Code Here
for (var acc in users){
    if (users[acc].email === 'tylermcginnis33@gmail.com' ){
        users.splice(acc,1);
    }
}
console.log(users);
